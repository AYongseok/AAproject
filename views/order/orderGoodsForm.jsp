...
<body>  
   ...
   <table class="goodsBuyForm2">  
      ...
      <tr style="border-bottom:2px solid lightgray;">
         <td>최종 결제액</td>
         <td><input type="hidden" id="total_finalPrice" name="total_finalResultPrice" value="${totalPrice - use_point}" /><span id="total_finalResultPrice">${totalPrice - use_point}</span>원</td>
      </tr>
   	<tr>
   	<td><input type="button" onclick="location.href='${contextPath}/goods/goodsListByCategory.do'" value="취소하기">
   	<input name="btn_process_pay_order" type="button"
     onClick="fn_process_pay_order()" value="구매하기"></td>
   	</tr>
