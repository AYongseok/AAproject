	   ...
	   <tr>
	    ...
	    <tr style="height:100px;"> 
	      ...
	      <td colspan="2">
	       ...
	       <input type=button value="목록보기"onClick="backToList(this.form)" style="width: 120px; height: 40px; font-size: 0.9em; font-weight: bold; background: rgb(245, 215, 0); border-radius: 5px; border: 0px; color: #fff; margin-left:70px;" " /><input type="hidden" name="viewCnt" value="0" />
